...
Десять навыков для промышленной разработки, архитектуры проектов, агентных процессов и ясного кода, краткие общие инструкции и переносимая конфигурация Codex.
