...
Вісімнадцять навичок для промислової розробки, дизайну, агентних процесів і зрозумілого письма, стислі загальні інструкції та мінімальна конфігурація Codex.
