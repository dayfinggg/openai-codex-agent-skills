...
- When repository administration is authorized, protect important branches against accidental force-push and deletion. Do not change server settings during a local code edit. Client hooks are convenience checks, not trust boundaries, because clients can omit or bypass them.
